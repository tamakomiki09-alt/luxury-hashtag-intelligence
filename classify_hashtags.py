...
CODEBOOK = {
    "Brand": (
        "Names the hotel, its parent group, or a proprietary campaign or "
        "programme belonging to it. Includes brand names in any script and "
        "coined campaign phrases. Examples: amantokyo, ritzcarlton, "
        "パークハイアット東京, rcmemories, luxuryispersonal, welcometojanu."
    ),
    "Place": (
        "Names a geographic location: country, city, ward, neighbourhood, "
        "district, landmark or transit hub. Examples: tokyo, japan, ginza, "
        "赤坂, marunouchi, 溜池山王, mtfuji."
    ),
    "Facility and service": (
        "Names something the hotel physically offers or sells: a restaurant, "
        "bar, spa, room type, afternoon tea, wedding or banquet service, pool, "
        "or a named outlet. Examples: afternoontea, spa, omakase, 結婚式, "
        "clublounge, sushi, patisserie."
    ),
    "Experience and lifestyle": (
        "Abstract, aspirational or affective language about how a stay feels "
        "or what it signifies, with no specific facility, place or brand named. "
        "Includes luxury-lifestyle positioning. Examples: luxurylifestyle, "
        "unforgettable, 癒し, elegance, staycation, rekindlethesoul."
    ),
    "Season and event": (
        "Tied to a specific time, season, holiday or one-off occasion. "
        "Examples: christmas, sakura, 桜, newyear, valentine, "
        "halloween, 母の日, anniversary."
    ),
    "Generic reach": (
        "Broad industry or travel-community tags used for discovery, carrying "
        "no brand, place or product specificity. Examples: luxuryhotel, "
        "travelgram, instatravel, hotellife, 旅行好きな人と繋がりたい, "
        "ホテル好きな人と繋がりたい."
    ),
    "Unclassifiable": (
        "Emoji-only, a personal name, an account handle belonging to someone "
        "else, gibberish, or a fragment whose meaning cannot be determined "
        "without seeing the post. Use this sparingly and only when a genuine "
